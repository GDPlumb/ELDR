...
1.  Run "parse.sh" in Data to create format the data

2.  Run "train_scvis.sh" in order to train the scvis model on the Bipolar data

3.  Set "num_clusters" in "Vertices/run.py" and then run it 
